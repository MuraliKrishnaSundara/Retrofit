...
public class MainActivity extends AppCompatActivity {
    ...
    */
    ...
    private void uploadImageToApi() {
        ...
        apiService.uploadImage(multiBody, "Jeff Bezos").enqueue(new Callback<ResponseDTO>() {
            @Override
            public void onResponse(Call<ResponseDTO> call, Response<ResponseDTO> response) {
                Toast.makeText(MainActivity.this, "The Image is Successfully Uploaded to Server", Toast.LENGTH_SHORT).show();
            }
